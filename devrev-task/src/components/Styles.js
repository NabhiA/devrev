...
export const SkeletonCard = styled.div`
  ...
  width: 200px; /* Adjust the width to match your card size */
  height: 300px; /* Adjust the height to match your card size */
...
export const SkeletonText = styled.div`
  width: 70%;
  height: 16px;
  background-color: #e0e0e0; /* Adjust the background color to match your design */
  margin: 10px 0;
`;
